...
namespace AllTest
{
    public class FolderBrowserDialogExampleForm : System.Windows.Forms.Form
    {
        ...
        public FolderBrowserDialogExampleForm()
        {
            ...
            this.openFileDialog1.DefaultExt = "ttf";
            this.openFileDialog1.Filter = "ttf files (*.ttf)|*.ttf";
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.FolderBrowserDialogExampleForm_Load);
            this.ResumeLayout(false);

        }

        private void FolderBrowserDialogExampleForm_Load(object sender, EventArgs e)
        {
